  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Device.measures.findById() instead.
        "prototype$__findById__measures": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Devices/:id/measures/:fk",
          method: "GET"
        },

        // INTERNAL. Use Device.measures.destroyById() instead.
        ...
        // INTERNAL. Use Device.measures.updateById() instead.
        ...
        // INTERNAL. Use Device.measures() instead.
        "prototype$__get__measures": {
          isArray: true,
          url: urlBase + "/Devices/:id/measures",
          method: "GET"
        },

        // INTERNAL. Use Device.measures.create() instead.
        "prototype$__create__measures": {
          url: urlBase + "/Devices/:id/measures",
          method: "POST"
        },

        // INTERNAL. Use Device.measures.destroyAll() instead.
        "prototype$__delete__measures": {
          url: urlBase + "/Devices/:id/measures",
          method: "DELETE"
        },

        // INTERNAL. Use Device.measures.count() instead.
        "prototype$__count__measures": {
          url: urlBase + "/Devices/:id/measures/count",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Device#getMeasures
         * @methodOf lbServices.Device
         *
         * @description
         *
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Device.measures
     * @header lbServices.Device.measures
     * @object
     * @description
     *
     * The object `Device.measures` groups methods
     * manipulating `Measure` instances related to `Device`.
     *
     * Call {@link lbServices.Device#measures Device.measures()}
     ...
     */
        ...
        R.measures = function() {
          ...
          var action = TargetResource["::get::Device::measures"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.measures#count
         * @methodOf lbServices.Device.measures
         *
         * @description
         *
         * Counts measures of Device.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         *  - `count` – `{number=}` - 
         */
        R.measures.count = function() {
          var TargetResource = $injector.get("Measure");
          var action = TargetResource["::count::Device::measures"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.measures#create
         * @methodOf lbServices.Device.measures
         *
         * @description
         *
         ...
         * </em>
         */
        R.measures.create = function() {
          var TargetResource = $injector.get("Measure");
          var action = TargetResource["::create::Device::measures"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.measures#createMany
         * @methodOf lbServices.Device.measures
         *
         * @description
         *
         ...
         * </em>
         */
        R.measures.createMany = function() {
          var TargetResource = $injector.get("Measure");
          var action = TargetResource["::createMany::Device::measures"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.measures#destroyAll
         * @methodOf lbServices.Device.measures
         *
         * @description
         *
         ...
         * This method returns no data.
         */
        R.measures.destroyAll = function() {
          var TargetResource = $injector.get("Measure");
          var action = TargetResource["::delete::Device::measures"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.measures#destroyById
         * @methodOf lbServices.Device.measures
         *
         * @description
         *
         ...
         * This method returns no data.
         */
        R.measures.destroyById = function() {
          var TargetResource = $injector.get("Measure");
          var action = TargetResource["::destroyById::Device::measures"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.measures#findById
         * @methodOf lbServices.Device.measures
         *
         * @description
         *
         ...
         * </em>
         */
        R.measures.findById = function() {
          var TargetResource = $injector.get("Measure");
          var action = TargetResource["::findById::Device::measures"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Device.measures#updateById
         * @methodOf lbServices.Device.measures
         *
         * @description
         *
         ...
         * </em>
         */
        R.measures.updateById = function() {
          var TargetResource = $injector.get("Measure");
          var action = TargetResource["::updateById::Device::measures"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#create
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#createMany
         * @methodOf lbServices.Measure
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#upsert
         * @methodOf lbServices.Measure
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#exists
         * @methodOf lbServices.Measure
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Measures/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Measure#findById
         * @methodOf lbServices.Measure
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#findOne
         * @methodOf lbServices.Measure
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Measures/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Measure#updateAll
         * @methodOf lbServices.Measure
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Measures/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Measure#deleteById
         * @methodOf lbServices.Measure
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#prototype$updateAttributes
         * @methodOf lbServices.Measure
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#createChangeStream
         * @methodOf lbServices.Measure
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/Measures/change-stream",
          method: "POST"
        },

        // INTERNAL. Use Device.measures.findById() instead.
        "::findById::Device::measures": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Devices/:id/measures/:fk",
        ...
        // INTERNAL. Use Device.measures.create() instead.
        "::create::Device::measures": {
          url: urlBase + "/Devices/:id/measures",
          method: "POST"
        },

        // INTERNAL. Use Device.measures.createMany() instead.
        "::createMany::Device::measures": {
          isArray: true,
          url: urlBase + "/Devices/:id/measures",
          method: "POST"
        },
        ...
        // INTERNAL. Use Device.measures.destroyAll() instead.
        "::delete::Device::measures": {
          url: urlBase + "/Devices/:id/measures",
          method: "DELETE"
        },

        // INTERNAL. Use Device.measures.count() instead.
        "::count::Device::measures": {
          url: urlBase + "/Devices/:id/measures/count",
          method: "GET"
        },
      }
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#updateOrCreate
         * @methodOf lbServices.Measure
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#update
         * @methodOf lbServices.Measure
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#destroyById
         * @methodOf lbServices.Measure
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Measure#removeById
         * @methodOf lbServices.Measure
         *
         * @description
         *
